...
var DetailsView = ValidatingView.extend({
    ...
    render: function() {
		...
		video_url='';
		if(this.model.videosourceSample()){
			video_url='http://192.168.9.76:8001/static/27cdb68/video.html?video_url='+this.model.videosourceSample();
			/*alert('render+video_url:'+video_url);*/
		}

        this.$el.find('.current-course-introduction-video iframe').attr('src', video_url);
    ...
    updateModel: function(event) {
        ...
        case 'course-introduction-video':
			...
			if(previewsource){
				video_url='http://192.168.9.76:8001/static/27cdb68/video.html?video_url='+this.model.videosourceSample();
				/*alert('update+video_url:'+video_url);*/
			}
            clearTimeout(this.videoTimer);
            this.videoTimer = setTimeout(_.bind(function() {
				
                this.$el.find(".current-course-introduction-video iframe").attr("src", video_url);
                this.$el.find(".current-course-introduction-video iframe").attr("scrolling", "no");
				this.$el.find(".current-course-introduction-video iframe").attr("frameborder", "0");
    ...
    uploadImage: function(event) {
        ...
        modal.show();
		window.FileUploadModel=FileUploadModel;
		window.FileUploadDialog=FileUploadDialog;
    }
