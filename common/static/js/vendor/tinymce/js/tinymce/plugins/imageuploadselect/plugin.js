...
tinymce.PluginManager.requireLangPack('imageuploadselect');

tinymce.PluginManager.add('imageuploadselect', function(editor, url) {



  UploadtDialog = window.UploadDialog;
...
function getImageSize(url, callback) {
	...
	function showImageUploadSelect(event) {
		
				window.SIZEs=4;
				window.TYPE=4;
				window.fileorimage=2;
			...
			window.showDialogImg=showDialog;

	}

	// Add a button to the button bar
    // EDX changed to show "HTML" on toolbar button
	editor.addButton('iuploadselect', {
		title: 'Upload Select',
        text: 'Image',
		icon: false,
		onclick: showImageUploadSelect
	});

	// Add a menu item to the tools menu
	editor.addMenuItem('iuploadselect', {
		icon: 'code',
		text: 'Upload Select',
		context: 'tools',
		onclick: showImageUploadSelect
