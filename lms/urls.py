...
if settings.COURSEWARE_ENABLED:
    urlpatterns += (
		...
		#url(r'^courses/search/?$', 'courseware.views.search_courses'),
		url(r'^category/?$', 'courseware.views.search_category', name="search_category"),
		url(r'^get_category/?$', 'courseware.views.get_search_category', name="search_category"),
		url(r'^getcourses/?$', 'courseware.views.get_search_courses', name="get_courses"),
        url(r'^courses/?$', 'courseware.views.search_courses', name="courses"),
